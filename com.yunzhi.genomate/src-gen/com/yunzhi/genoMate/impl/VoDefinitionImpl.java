...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Vo Definition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.yunzhi.genoMate.impl.VoDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.yunzhi.genoMate.impl.VoDefinitionImpl#getSerializable <em>Serializable</em>}</li>
 *   <li>{@link com.yunzhi.genoMate.impl.VoDefinitionImpl#getLombokAnnotation <em>Lombok Annotation</em>}</li>
 *   <li>{@link com.yunzhi.genoMate.impl.VoDefinitionImpl#getExclusions <em>Exclusions</em>}</li>
 *   <li>{@link com.yunzhi.genoMate.impl.VoDefinitionImpl#getExcludeAll <em>Exclude All</em>}</li>
 *   <li>{@link com.yunzhi.genoMate.impl.VoDefinitionImpl#getJacksons <em>Jacksons</em>}</li>
 *   <li>{@link com.yunzhi.genoMate.impl.VoDefinitionImpl#getAddField <em>Add Field</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VoDefinitionImpl extends MinimalEObjectImpl.Container implements VoDefinition
{
  /**
  ...
  /**
   * The cached value of the '{@link #getJacksons() <em>Jacksons</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getJacksons()
   * @generated
   * @ordered
   */
  protected EList<VoJackson> jacksons;
   ...
   * @ordered
   */
  protected EList<VoAddField> addField;
  ...
  {
    return GenoMatePackage.Literals.VO_DEFINITION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GenoMatePackage.VO_DEFINITION__NAME, oldName, name));
  }
  ...
  public void setSerializable(String newSerializable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GenoMatePackage.VO_DEFINITION__SERIALIZABLE, oldSerializable, serializable));
  }
  ...
  public EList<LombokAnnotation> getLombokAnnotation()
  {
    ...
    {
      lombokAnnotation = new EObjectContainmentEList<LombokAnnotation>(LombokAnnotation.class, this, GenoMatePackage.VO_DEFINITION__LOMBOK_ANNOTATION);
    }
  ...
  public EList<Exclusions> getExclusions()
  {
    if (exclusions == null)
    {
      exclusions = new EObjectContainmentEList<Exclusions>(Exclusions.class, this, GenoMatePackage.VO_DEFINITION__EXCLUSIONS);
    }
    return exclusions;
  }
  ...
  public void setExcludeAll(String newExcludeAll)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GenoMatePackage.VO_DEFINITION__EXCLUDE_ALL, oldExcludeAll, excludeAll));
  }
   ...
   */
  @Override
  public EList<VoJackson> getJacksons()
  {
    if (jacksons == null)
    {
      jacksons = new EObjectContainmentEList<VoJackson>(VoJackson.class, this, GenoMatePackage.VO_DEFINITION__JACKSONS);
    }
    return jacksons;
  }
   ...
   */
  @Override
  public EList<VoAddField> getAddField()
  {
    if (addField == null)
    {
      addField = new EObjectContainmentEList<VoAddField>(VoAddField.class, this, GenoMatePackage.VO_DEFINITION__ADD_FIELD);
    }
    return addField;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case GenoMatePackage.VO_DEFINITION__LOMBOK_ANNOTATION:
        return ((InternalEList<?>)getLombokAnnotation()).basicRemove(otherEnd, msgs);
      case GenoMatePackage.VO_DEFINITION__EXCLUSIONS:
        return ((InternalEList<?>)getExclusions()).basicRemove(otherEnd, msgs);
      case GenoMatePackage.VO_DEFINITION__JACKSONS:
        return ((InternalEList<?>)getJacksons()).basicRemove(otherEnd, msgs);
      case GenoMatePackage.VO_DEFINITION__ADD_FIELD:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case GenoMatePackage.VO_DEFINITION__NAME:
        return getName();
      case GenoMatePackage.VO_DEFINITION__SERIALIZABLE:
        return getSerializable();
      case GenoMatePackage.VO_DEFINITION__LOMBOK_ANNOTATION:
        return getLombokAnnotation();
      case GenoMatePackage.VO_DEFINITION__EXCLUSIONS:
        return getExclusions();
      case GenoMatePackage.VO_DEFINITION__EXCLUDE_ALL:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case GenoMatePackage.VO_DEFINITION__JACKSONS:
        getJacksons().clear();
        getJacksons().addAll((Collection<? extends VoJackson>)newValue);
        return;
      case GenoMatePackage.VO_DEFINITION__ADD_FIELD:
        getAddField().clear();
        getAddField().addAll((Collection<? extends VoAddField>)newValue);
        return;
    }
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case GenoMatePackage.VO_DEFINITION__JACKSONS:
        return jacksons != null && !jacksons.isEmpty();
      case GenoMatePackage.VO_DEFINITION__ADD_FIELD:
